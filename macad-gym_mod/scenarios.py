...
SSUI3C_TOWN3 = {
    "map": "Town01",
    "actors": {
        "car1": {"start": 88, "end": 28},
        "bike1": {
            "start": 89,
            "end": 26,
        },  # "start": [170.5, 80, 0.4], "end": [144, 59, 0]
        "car2": {"start": 29, "end": 151},
    },
...
SUIC3_TOWN3 = {
    ...
    "actors": {
        ...
        "car3": {"start": [43, -133, 4], "end": [100, -132, 8],},
    },
    "weather_distribution": [0],
    "max_steps": 500,
}
...
SUI1B2C1P_TOWN3 = {
    "map": "Town03",
    "actors": {
        "car1": {"start": [94, -132.7, 10], "end": [106, -132.7, 8],},
        "car2": {"start": [84, -115, 10], "end": [41, -137, 8],},
        "pedestrian1": {"start": [74, -126, 10, 0.0], "end": [92, -125, 8],},
        "bike1": {"start": [69, -132, 8], "end": [104, -132, 8],},
    },
    "max_steps": 200,
}
...
DEFAULT_SCENARIO_TOWN1_COMBINED_WITH_MANUAL = build_ma_scenario(
    ...
    actors={
        "vehicle1": {
            ...
            "end": [299.39996337890625, 199.05999755859375, 39.430625915527344, -0.16],
        },
        "vehicle2": {"start": 133, "end": 65},
        "manual": {
            "start": [
            ...
            "end": [217.50997924804688, 194.05999755859375, 39.430625915527344, 180.0],
        },
    },
    max_steps=2000,
    weathers=[0],
